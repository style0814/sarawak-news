        ...
        <div className={`prose max-w-none ${isDark ? 'prose-invert' : ''}`}>
          <section className={`rounded-2xl p-8 mb-6 ${isDark ? 'bg-gray-800' : 'bg-white shadow-sm'}`}>
            ...
            <p className={`${isDark ? 'text-gray-300' : 'text-gray-600'}`}>
              If you have any questions about this Privacy Policy, please contact us through the feedback form on our <Link href="/ai-features" className="text-emerald-600 hover:underline">AI Features</Link> page.
            </p>
          </section>
        </div>
      </main>
